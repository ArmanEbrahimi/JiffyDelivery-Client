...
import com.example.jiffydeliveryclient.SplashScreenActivity
import com.example.jiffydeliveryclient.databinding.ActivityHomeBinding
...
class HomeActivity : AppCompatActivity() {
    ...
    private fun init() {
        ...
        if (Constants.currentClient != null && Constants.currentClient?.avatar != null &&
            !TextUtils.isEmpty(Constants.currentClient?.avatar)) {

            Picasso.get()
                .load(Constants.currentClient?.avatar)
                .into(imageAvatar)
        } else {
        ...
        textViewPhone.text = Constants.currentClient?.phoneNumber
        textViewStar.text = java.lang.StringBuilder().append(Constants.currentClient?.rating)
    }
